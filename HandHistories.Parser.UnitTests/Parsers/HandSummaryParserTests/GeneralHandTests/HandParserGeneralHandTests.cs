...
namespace HandHistories.Parser.UnitTests.Parsers.HandSummaryParserTests.GeneralHandTests
{
    ...
    class HandParserGeneralHandTests : HandHistoryParserBaseTests 
    {
        ...
        {            
            Assert.AreEqual(_expectedHandId, GetParser().ParseHandId(_handText), "IHandHistorySummaryParser: ParseHandId");
        ...
        {
            var summary = GetParser().ParseFullHandSummary(_handText);
        ...
        public void ParseDateOfHand_ConvertsToUtcDateTime()
        {
            ...
            {
                case SiteName.Values.Unknown:
                    Assert.Ignore("Not implemented for site " + Site);
                    break;
            }

            Assert.AreEqual(_expectedDateTime, GetParser().ParseDateUtc(_handText), "IHandHistorySummaryParser: ParseDateUtc");
        ...
        public void ParseDealerButtonPosition_Works()
        {
            ...
            Assert.AreEqual(_expectedDealerButtonPosition, GetParser().ParseDealerPosition(_handText), "IHandHistorySummaryParser: ParseDealerPosition");
        ...
        public void ParseNumPlayers_Works()
        {
            ...
            Assert.AreEqual(_expectedNumberOfPlayers, GetParser().ParseNumPlayers(_handText), "IHandHistorySummaryParser: ParseNumPlayers");
