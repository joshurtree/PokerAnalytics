    ...
    class HandParserHandActionTestsPartyPokerImpl : HandParserHandActionTests
    {
        ...
        public void ParseTimeBank_Works()
        {
            List<HandAction> expectedActions = new List<HandAction>()
            {
                ...
                new WinningsAction("Player2", HandActionType.WINS, 0.24m, 0, Street.Flop),
            };
            ...
            List<HandAction> expectedActions = new List<HandAction>()
                                    {
                                        ...
                                        new WinningsAction("Player1", HandActionType.WINS, 0.78m, 0, Street.River),
                                    };
            ...
            List<HandAction> expectedActions = new List<HandAction>()
                                    {
                                        ...
                                        new WinningsAction("Player5", HandActionType.WINS, 0.21m, 0, Street.Turn),
                                    };
                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("udob57", HandActionType.WINS, 0.15m,  0, Street.Preflop),                              
                           };
            }
        }
                ...
                return new List<HandAction>()
                                      {
                                          ...
                                          new WinningsAction("Kelevra_91", HandActionType.WINS, 5.18m, 0, Street.Flop),
                                      };
            }
        }
