                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("BONUS 1OOO", HandActionType.WINS, 3.80m, 0, Street.Flop),
                               new HandAction("BONUS 1OOO", HandActionType.UNCALLED_BET, 2.5m, Street.Flop),
                           };
            }
        }
                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("kliketiklok", HandActionType.WINS, 1, 0, Street.Preflop),
                               new HandAction("kliketiklok", HandActionType.UNCALLED_BET,0.5m, Street.Preflop), // 1 ( BB ) - 0.5 ( SB )
                           };
            }
        }
                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("fyabcf", HandActionType.WINS, 4m, 0, Street.Preflop),                           
                               new HandAction("fyabcf", HandActionType.UNCALLED_BET, 4m, Street.Preflop), // 5 + 1 (BB) - 1.5 - 0.5(SB)          
                           };
            }
        }
                ...
                return new List<HandAction>()
                           {
                               ...
                               new HandAction("fyabcf", HandActionType.UNCALLED_BET,  123.24m, Street.Flop), // 18 + 192.15 - 36 - 50.91
                           };
            }
        }
            ...
            List<HandAction> expectedActions = new List<HandAction>()
                                    {
                                        ...
                                        new HandAction("Dbcee89", HandActionType.FOLD, 0, Street.Preflop),
                                        new HandAction("BlackH0L3", HandActionType.FOLD, 0, Street.Preflop),
                                        new WinningsAction("kliketiklok", HandActionType.WINS, 2.5m, 0, Street.Preflop),
                                        new HandAction("kliketiklok", HandActionType.UNCALLED_BET, 1m, Street.Preflop), // 2 - 1 ( BB )
                                    };
