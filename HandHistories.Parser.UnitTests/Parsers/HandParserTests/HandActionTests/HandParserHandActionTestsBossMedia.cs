                ...
                return new List<HandAction>()
                                    {
                                        ...
                                        new WinningsAction("1Mentalist", HandActionType.WINS, 29.26m, 0, Street.River),  
                                    };
            }
        }
                ...
                return new List<HandAction>()
                                    {
                                        ...
                                        new WinningsAction("ItalyToast", HandActionType.WINS, 400m, 0, Street.Preflop),  
                                    };
            }
        }
                ...
                return new List<HandAction>()
                                    {
                                        ...
                                        new WinningsAction("Supervic", HandActionType.WINS, 2985m, 0, Street.Flop)
                                    };
            }
        }
                ...
                return new List<HandAction>()
                                    {
                                        ...
                                        new WinningsAction("ItalyToast", HandActionType.WINS, 105.08m, 0, Street.River),  
                                    };
            }
        }
    }
