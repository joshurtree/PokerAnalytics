            ...
            List<HandAction> expectedActions = new List<HandAction>()
                {
                    ...
                    new WinningsAction("888game888", HandActionType.WINS, 30m, 0, Street.Turn)
                };
            ...
            List<HandAction> expectedActions = new List<HandAction>()
                {
                    ...
                    new WinningsAction("D3SISION", HandActionType.WINS, 0.30m, 0, Street.Flop)
                };
            ...
            List<HandAction> expectedActions = new List<HandAction>()
                {
                    ...
                    new WinningsAction("kenzielee", HandActionType.WINS, 0.54m, 0, Street.Flop)
                };
            ...
            List<HandAction> expectedActions = new List<HandAction>()
                                    {
                                        ...
                                        new WinningsAction("tonyaces", HandActionType.WINS, 1.5m, 0, Street.Preflop)
                                    };
            ...
            List<HandAction> expectedActions = new List<HandAction>()
                                    {
                                        ...
                                        new WinningsAction("COMON-JOE-JUG", HandActionType.WINS, 25.75m, 0, Street.Flop),
                                    };
            ...
            List<HandAction> expectedActions = new List<HandAction>()
                {
                    ...
                    new WinningsAction("((((??????!!!!!!))))", HandActionType.WINS, 6m, 0, Street.Preflop)
                };
            ...
            List<HandAction> expectedActions = new List<HandAction>()
                           {
                               ...
                               new WinningsAction("Daviciko", HandActionType.WINS, 0.35m,0, Street.Preflop),
                           };
                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("LadyStack", HandActionType.WINS, 0.25m, 0, Street.Preflop),
                           };
            }
        }
                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("digbick30", HandActionType.WINS, 23m, 0, Street.River),
                           };
            }
        }
