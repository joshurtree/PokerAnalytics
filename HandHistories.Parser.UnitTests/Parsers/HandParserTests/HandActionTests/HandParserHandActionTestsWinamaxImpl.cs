                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("sined20", HandActionType.WINS,6.01m,0, Street.Flop)
                           };
             }
         }
                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new HandAction("titi250", HandActionType.FOLD, 0, Street.Preflop),
                               new WinningsAction("fanf4K UR0", HandActionType.WINS, 2,0, Street.Preflop)
                           };
             }
         }
                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("totti6720", HandActionType.WINS, 11.24m, 0, Street.Flop),                               
                           };
             }
         }
