                ...
                return new List<HandAction>()
                           {
                               ...
                               new HandAction("anica11", HandActionType.MUCKS, 0, Street.Preflop),
                               new WinningsAction("anica11", HandActionType.WINS, 51.66m, 0, Street.Preflop),                               
                           };
            }
        }
                ...
                return new List<HandAction>()
                           {
                               ...
                               new HandAction("cashgreedy00", HandActionType.MUCKS, 0, Street.Preflop),
                               new WinningsAction("cashgreedy00", HandActionType.WINS, 11m, 0, Street.Preflop),                               
                           };
            }
        }
