                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("FCSM_1935", HandActionType.WINS, 0.19m, 0, Street.Flop),             
                               new HandAction("FCSM_1935", HandActionType.UNCALLED_BET, 0.1m, Street.Flop),                  
                           };
             }
         }
                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("dbhbrb", HandActionType.WINS, 2.50m, 0, Street.Preflop),          
                               new HandAction("dbhbrb", HandActionType.UNCALLED_BET, 1m, Street.Preflop), // 2 - 1  ( BB ) 
                           };
             }
         }
                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("cashgamer15", HandActionType.WINS, 34.30m, 0, Street.River),     
                               new HandAction("cashgamer15", HandActionType.UNCALLED_BET, 36.10m, Street.River),                          
                           };
             }
         }
                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new HandAction("qprcuz", HandActionType.UNCALLED_BET, 5.28m, Street.River),  // 101.66 - 6.55 - 79.83               
                           };
             }
         }
