            ...
            List<HandAction> expectedActions = new List<HandAction>()
                {
                    ...
                    new WinningsAction("JJScvbnm", HandActionType.WINS, 2.50m, 0, Street.Preflop),
                    new HandAction("JJScvbnm", HandActionType.MUCKS,0, Street.Preflop)
                };
            ...
            List<HandAction> expectedActions = new List<HandAction>()
                                    {
                                        ...
                                        new WinningsAction("wo_ooly :D", HandActionType.WINS, 2.50m, 0, Street.Preflop),
                                        new HandAction("wo_ooly :D", HandActionType.MUCKS,0, Street.Preflop)
                                    };
            ...
            List<HandAction> expectedActions = new List<HandAction>()
                                    {
                                        ...
                                        new WinningsAction("Beeethoven87", HandActionType.WINS, 2.50m, 0, Street.Preflop),
                                        new HandAction("Beeethoven87", HandActionType.MUCKS,0, Street.Preflop)
            ...
            List<HandAction> expectedActions = new List<HandAction>()
                                    {
                                        ...
                                        new WinningsAction("idirabotai", HandActionType.WINS, 13.50m, 0, Street.Turn),
                                        new HandAction("idirabotai", HandActionType.MUCKS, 0, Street.Turn)
                                    };
                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("jweeke", HandActionType.WINS, 2m, 0, Street.Preflop),
                               new HandAction("jweeke", HandActionType.MUCKS, 0, Street.Preflop)
                           };
            }
        }
                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("LovID", HandActionType.WINS, 0.87m, 0, Street.Preflop),
                               new HandAction("LovID", HandActionType.MUCKS, 0, Street.Preflop)
                           };
            }
        }
