    ...
    class HandParserHandActionTestsMicroGamingImpl : HandParserHandActionTests
    {
        ...
        public void TestDisconnectedActions()
        {
            var actions = new List<HandAction>()
            {
                ...
                new WinningsAction("tuffgong", HandActionType.WINS, 99m, 0, Street.Preflop),    
            };
                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("_joker_", HandActionType.WINS, 0.16m, 0, Street.Preflop),                               
                           };
             }
         }
                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new HandAction("_joker_", HandActionType.MUCKS, 0m, Street.Preflop),
                               new WinningsAction("_joker_", HandActionType.WINS, 0.08m, 0, Street.Preflop),                               
                           };
             }
         }
                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("Muszkliii", HandActionType.WINS, 0.23m, 0, Street.Preflop),                               
                           };
             }
         }
