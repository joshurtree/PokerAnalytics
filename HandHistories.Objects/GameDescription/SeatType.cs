...
namespace HandHistories.Objects.GameDescription
{
    [Serializable]
    [DataContract]
    [BsonSerializer(typeof(SeatTypeSerializer))]
    public partial struct SeatType
    {
        ...
        public SeatType(int maxPlayers, bool realTypes)
        {            
            switch (maxPlayers)
            {
                case -1:
                case 0:
                    Type = SeatTypeEnum.All;
                    break;   
                case 2:
                    Type = SeatTypeEnum.HeadsUp;
                    break;
                case 3:
                    Type = realTypes ? SeatTypeEnum._6Max : SeatTypeEnum._3Handed;
                    break;
                case 4:
                    Type = realTypes ? SeatTypeEnum._6Max : SeatTypeEnum._4Max;
                    break;
                case 5:
                    Type = realTypes ? SeatTypeEnum._6Max : SeatTypeEnum._5Handed;
                    break;
                case 6:
                    Type = SeatTypeEnum._6Max;
                    break;
                case 7:
                    Type = realTypes ? SeatTypeEnum._FullRing_9Handed : SeatTypeEnum._7Handed;
                    break;
                case 8:
                    Type = realTypes ? SeatTypeEnum._FullRing_9Handed : SeatTypeEnum._8Handed;
                    break;
                case 9:
                    Type = SeatTypeEnum._FullRing_9Handed;
                    break;
                case 10:
                    Type = SeatTypeEnum._FullRing_10Handed;
                    break;
                default:
        ...
        public bool isEmpty
        {
            get
            {
                return Type == SeatTypeEnum.Unknown; 
            }
        }
