...
{
    public sealed class MergeFastParserImpl : HandHistoryParserFast
    {
        public override SiteName SiteName
        {
            get { return SiteName.Values.Merge; }
        }
        ...
        {
            isCancelled = string.Join("", handLines).IndexOf("GAME_CANCELLED") != -1;
        ...
        private WinningsAction GetWinningsActionFromWinnerElement(XElement winnerElement, PlayerList playerList)
        {
            ...
            return new WinningsAction(matchingPlayer.PlayerName, HandActionType.WINS, amount, potNumber, Street.Showdown, Int32.MaxValue);
        }
