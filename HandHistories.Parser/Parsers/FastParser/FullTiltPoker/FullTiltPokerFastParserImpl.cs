...
{
    public sealed class FullTiltPokerFastParserImpl : HandHistoryParserFast, IThreeStateParser
    {
        public override SiteName SiteName
        {
            get { return SiteName.Values.FullTilt; }
        }
        ...
        public void ParseShowDown(string[] handLines, ref List<HandAction> actions, int lineIndex, GameType gametype)
        {
            for (int i = lineIndex; i < handLines.Length; i++)
            {
                ...
                {
                    actions.Add(new HandAction(line.Remove(line.Length - 6), HandActionType.MUCKS, 0, Street.Showdown));
                }
                ...
                else if (line.Contains(" wins "))
                {
                    ...
                    actions.Add(new WinningsAction(playerName, HandActionType.WINS, amount, 0, Street.Showdown));
                }
...
#warning duplicate parse winning actions
        ...
        static HandAction ParseWinActionOrStreet(string line, ref Street currentStreet)
        {
            ...
            switch (idChar)
            {
                ...
                case '8':
                case '9':
                    return ParseWinAction(line, currentStreet);
        ...
        static HandAction ParseWinAction(string line, Street street)
        {
            ...
            return new WinningsAction(playerName, HandActionType.WINS, amount, 0, street);
        }
        ...
        static HandAction ParseFoldCheckLine(string line, Street currentStreet)
        {
            ...
            {
                string playerName = line.Remove(line.Length - 6);
                return new HandAction(playerName, HandActionType.MUCKS, 0, currentStreet);
            }
