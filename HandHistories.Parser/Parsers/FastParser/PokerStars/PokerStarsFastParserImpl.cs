...
{
    public class PokerStarsFastParserImpl : HandHistoryParserFast, IThreeStateParser
    {
        ...
        public PokerStarsFastParserImpl(SiteName.Values siteName = SiteName.Values.PokerStars)
        {
            _siteName = siteName;
        ...
        protected override string ParseTournamentId(string[] handLines)
        {
            ...
            if(format == PokerFormat.SitAndGo || format == PokerFormat.MultiTableTournament)
            {
                ...
                return handLines[0].Substring(TournamentIdStartindex, endIndex - TournamentIdStartindex);
            }
        ...
        protected override Buyin ParseBuyin(string[] handLines)
        {
            ...
            return new Buyin(prizePoolValue + knockoutValue, rake, currency);
        }
