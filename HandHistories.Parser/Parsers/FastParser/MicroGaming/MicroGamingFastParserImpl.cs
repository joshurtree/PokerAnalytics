...
{
    internal sealed class MicroGamingFastParserImpl : HandHistoryParserFast
    {
        public override bool RequiresSittingOutAssesment
        {
            get
            {
                return true;
        ...
        {
            get { return SiteName.Values.MicroGaming; }
        }
