...
{
    sealed class EntractionFastParserImpl : HandHistoryParserFast
    {
        public override SiteName SiteName
        {
            get { return SiteName.Values.Entraction; }
        }
        ...
        protected override List<HandAction> ParseHandActions(string[] handLines, GameType gameType = GameType.Unknown)
        {
            ...
            for (int i = 3; i < handLines.Length - 1; i++)
            {
                ...
                if (handLine.Contains(" wins: "))
                {
                    ...
                    handActions.Add(new WinningsAction(name, HandActionType.WINS, amount, 0, currentStreet));
                    continue;
                }
